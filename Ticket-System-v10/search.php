    ...
    <body>
      ...
      <?php
          ...
          if (isset($_POST['searchresult'])){
            ...
            $queryStaff = "(SELECT * FROM ticket_STAFF WHERE t_ID LIKE '%$getresult%' OR t_USER LIKE '%$getresult%' OR t_UID LIKE '%$getresult%' OR t_CAT LIKE '%$getresult%')";
            $queryCustomer = "(SELECT * FROM ticket_CUSTOMER WHERE t_ID LIKE '%$getresult%' OR t_USER LIKE '%$getresult%' OR t_UID LIKE '%$getresult%' OR t_CAT LIKE '%$getresult%')";
            ...
            echo "<p> <div class = 'row header'>
                    ...
                    while($row = mysqli_fetch_row($resultCustomer)){
                        echo "
                            <p> 
                            <div class = 'row'>
                    ...
                    while($row = mysqli_fetch_row($resultStaff)){
                      echo "
                          <p> 
                          <div class = 'row'>
