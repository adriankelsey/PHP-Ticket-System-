    ...
    <body>
      ...
      <nav class="navbar">
        ...
        echo "<div class='new1-ticket'>
                <h1>New Staff Ticket</h1>
                <form class ='new-ticket-form' action = includes/addTicket.php method= post>
                    <div class='row user'>
                        <div class='col user'>User:</div>
                        <input class='n first-name' placeholder='First Name' type='text' name= adduserF>
                        <input class='n last-name' placeholder='Last Name' type='text'  name= adduserL>
                    </div>
                    <div class='row title'>
                    ...
                    <div class='row user-group'>
                        ...
                        <input readonly class='n user-group' value='STAFF' type='text' name= addusergroup>
                    </div>
                    ...
                    <div class='row buttons'>
                        <input type=submit href=includes/addTicket.php name= submitStaffTicket class='btn add' value='ADD'>
