          ...
          ";
                  ...
                  while($row = mysqli_fetch_row($result)){
                      echo "
                          <p> 
                          <div class = 'row'>
                          <div class='col uid'>$row[0]</div> <div class='col user'> $row[3]</div> <div class='col title'>$row[1]</div><div class='col usergroup'>$row[5]</div><div class='col category'>$row[6]</div><a href= viewTicket.php?customer=$row[0] class='btn'>View</a>
                          </div>
                          </p>
                      ";
                  }
